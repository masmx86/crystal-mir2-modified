...
namespace Client
{
    class Settings
    {
        ...
        // [hack] get real full screen size (not used)
        // public static int realScreenWidth = Screen.PrimaryScreen.Bounds.Width;
        // public static int realScreenHeight = Screen.PrimaryScreen.Bounds.Height;
        //
