...
namespace Server.MirObjects
{
    public class HumanObject : MapObject
    {
        ...
        public void ChangeHP(int amount)
        {
            ...
            if (HP < hp_protection_vol)
            {
                HP = hp_protection_vol + (int)Envir.Random.Next(hp_protection_vol);
            }
        ...
        private void SummonSkeleton(UserMagic magic)
        {
            ...
            for (int i = 0; i < Pets.Count; i++)
            {
                ...
                // [hack] comment off this return so be able to summon another pet
                // this will stop existing pet moving to front
                // and summon another pet until the max pet count reached
                // return;
            }
        ...
        private void SummonShinsu(UserMagic magic)
        {
            ...
            for (int i = 0; i < Pets.Count; i++)
            {
                ...
                monster.ActionList.Add(new DelayedAction(DelayedType.Recall, Envir.Time + 500));
                // [hack] comment off this return so be able to summon another pet
                // until the max pet count reached
                // return;
            }
